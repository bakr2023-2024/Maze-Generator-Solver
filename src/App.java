...
public class App {
	...
	static boolean canSimulate = false;
	...
	public static class MazeComponent extends JComponent
		...
		public MazeComponent(int[][] maze) {
			this.maze = maze;
			simulation = new JButton("Run Simulation");
		...
		protected void paintComponent(Graphics g) {
			...
			if (this.running || startx < 0 || starty < 0 || endx < 0 || endy < 0)
	...
	public static void main(String[] args) {
		...
		simulation.addActionListener(e -> {
			Mainframe simFrame = new Mainframe(component.maze);
		});
		c.gridy = 11;
		rightPanel.add(simulation, c);
		solveButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				} else if (solveButton.getText().equals("Stop")) {
					MazeSolver.keepSolving = false;
					solveText.setText("Stopped");
					solveButton.setText("Restart");
				} else if (solveButton.getText().equals("Restart")) {
					component.startx = -1;
					component.starty = -1;
					component.endx = -1;
					component.endy = -1;
